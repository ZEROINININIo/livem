...
import { User, Activity, Shield, Sparkles, Hash, Zap, Cpu, Brain, Heart, Wind, Share2, Network, ShieldAlert } from 'lucide-react';
...
const relationships: Record<string, string[]> = {
  ...
  'zeri': ['point', 'zelo', 'void', 'dusk-rain', 'byaki'],
...
export default function CharactersPage({ language }: CharactersPageProps) {
  ...
  // Identify censored characters: Zeri, Byaki, Void
  const isStatsEncrypted = ['zeri', 'byaki', 'void'].includes(selectedId);
         ...
         <main key={selectedChar.id} className="flex-1 flex flex-col xl:flex-row h-full overflow-hidden bg-ash-black">
             ...
             <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-8 relative">
                 ...
                 <div className="flex flex-col lg:flex-row gap-8 items-start">
                     ...
                     {/* Stats Box - Compact */}
                     <div className="w-full lg:w-[280px] bg-ash-dark p-4 border-2 border-ash-gray shadow-hard relative">
                         {/* Encrypted Overlay */}
                         {isStatsEncrypted && (
                             <div className="absolute inset-0 z-20 bg-ash-black/80 backdrop-blur-sm flex flex-col items-center justify-center border-2 border-red-500/20 m-[-2px]">
                                 <div className="relative">
                                     <ShieldAlert size={48} className="text-red-600 animate-pulse relative z-10" />
                                     <div className="absolute inset-0 bg-red-500 blur-xl opacity-20 animate-pulse"></div>
                                 </div>
                                 <div className="mt-4 text-center">
                                     <div className="text-xl font-black text-red-600 tracking-widest glitch-text-heavy" data-text="ENCRYPTED">ENCRYPTED</div>
                                     <div className="text-[9px] font-mono text-red-400 mt-2 uppercase tracking-wider">
                         ...
                         <div className={`transition-all duration-500 ${isStatsEncrypted ? 'opacity-20 blur-sm grayscale pointer-events-none' : ''}`}>
